...
double relu_back(const double x,
                 const double d);  // High Order functions Definitions
...
double reduce(std::function<double(double, double)> fn, double start,
              const std::vector<double>& ls);  // Utility functions using high
                                               // order function defined above
